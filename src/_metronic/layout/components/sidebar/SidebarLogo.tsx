...
import { getLogo } from '../../../../app/constructor/helpers/dynamicStyles'
...
const SidebarLogo = () => {
  ...
  return (
    <div className='app-sidebar-logo px-9' id='kt_app_sidebar_logo'>
      <Link to='/dashboard'>
        {config.layoutType === 'dark-sidebar' ? (
          <img
            alt='Logo'
            src={toAbsoluteUrl(`/media/crm/logos/${getLogo()[mode === "dark" ? "dark" : "light"]}`)}
          ...
          <>
            <img
              alt='Logo'
              src={toAbsoluteUrl(`/media/crm/logos/${getLogo().light}`)}
              className='h-35px app-sidebar-logo-default theme-light-show'
            />
            <img
              alt='Logo'
              src={toAbsoluteUrl(`/media/crm/logos/${getLogo().dark}`)}
              className='h-35px app-sidebar-logo-default theme-dark-show'
            />
          </>
        )}
        {/* минимизированное лого, нужно сделать */}
        {/*  <img
          alt='Logo'
