...
import { TComponentArray, TComponentArrayFormField, TComponentArrayItem, TField } from "./_types"

const Field: React.FC<TField> = ({ field }) => {
...
const ComponentArrayFormField: React.FC<TComponentArrayFormField> = ({ field, values }) => {
...
const ComponentArrayItem: React.FC<TComponentArrayItem> = props => {
    const { label, value, isObject, draggable, handleClick, handleOnDrag, handleOnDrop } = props
...
const ComponentArray: React.FC<TComponentArray> = ({ label, article, data_type, fields, customHandler, draggable }) => {
    const intl = useIntl()
