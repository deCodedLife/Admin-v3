...
import { TSalaryProgressbar, TSalaryRange, TSalary } from "./_types"
...
const ModuleSalaryProgressbar: React.FC<TSalaryProgressbar> = ({ values }) => {
...
const ModuleSalaryRange: React.FC<TSalaryRange> = ({ values }) => {
    const currentActualValue = useMemo(() => {
...
const ModuleSalaryWidget: React.FC<{ salary: TSalary }> = ({ salary }) => {
    switch (salary.type) {
        case "progressbar":
