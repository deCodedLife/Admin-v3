...
import {
    TModuleSchedule,
    TModuleScheduleCell,
    TModuleScheduleComponentCell,
    TModuleScheduleComponentColumn,
    TModuleScheduleDateColumn,
    TModuleScheduleModal,
    TModuleScheduleScrollButtons,
    TModuleScheduleServerCell,
...
const ModuleScheduleCell: React.FC<TModuleScheduleComponentCell> = props => {
    const {
        type,
        date,
        time,
...
const ModuleScheduleColumn: React.FC<TModuleScheduleComponentColumn> = (props) => {
...
const ModuleScheduleDateColumn: React.FC<TModuleScheduleDateColumn> = ({ date, body, setSelectedCell }) => {
...
const ModuleScheduleStepsColumn: React.FC<TModuleScheduleStepsColumn> = ({ steps, setFilter }) => {
    const intl = useIntl()
...
const ModuleScheduleTable = React.memo<TModuleScheduleTable>(props => {
    const { steps, schedule, tableRef, setSelectedCell, setFilter } = props
...
const ModuleScheduleScrollButtons = React.memo<TModuleScheduleScrollButtons>(({ scrollTable }) => {
