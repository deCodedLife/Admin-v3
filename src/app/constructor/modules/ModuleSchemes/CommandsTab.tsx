...
import { ApiCommandSchemeType } from "../../../types/api"
import { ModuleSchemesCommandFormType, ModuleSchemesCommandsTabType } from "../../../types/modules"
import { booleanResponsesList, commandTypes } from "./helpers/listsItems"
import setModalIndex from "../../helpers/setModalIndex"

const CommandForm: React.FC<ModuleSchemesCommandFormType> = ({ data, selectedScheme, mutate, deleteScheme = () => { } }) => {
...
const CommandsTab: React.FC<ModuleSchemesCommandsTabType> = ({ schemes, mutate, deleteScheme }) => {
    const [selectedScheme, setSelectedScheme] = useState<string | undefined>(undefined)
    const { data } = useSchemes<ApiCommandSchemeType>("command", "command", selectedScheme)
