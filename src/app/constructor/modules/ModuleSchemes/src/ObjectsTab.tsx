...
import { TApiObjectScheme, TApiResponse } from "../../../../types/api"
...
import {TModuleSchemesObjectForm, TModuleSchemesObjectPropertyRow, TModuleSchemesOblectsTab} from "../_types";

const ObjectPropertyRow: React.FC<TModuleSchemesObjectPropertyRow> = props => {

    const { parentArticle, rowIndex, databaseTables, currentSchemeCommands, isLastProperty } = props
...
const ObjectForm: React.FC<TModuleSchemesObjectForm> = props => {

    const { data, selectedScheme, databaseTables, currentSchemeCommands, mutate, deleteScheme = () => { } } = props
...
const ObjectsTab: React.FC<TModuleSchemesOblectsTab> = props => {

    const { schemes, tabs, mutate, deleteScheme } = props
    const [selectedScheme, setSelectedScheme] = useState<string | undefined>(undefined)
    const { data } = useSchemes<TApiObjectScheme>("object", "object", selectedScheme)
