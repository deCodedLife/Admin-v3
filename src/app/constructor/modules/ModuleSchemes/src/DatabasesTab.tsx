...
import { TApiDatabaseScheme } from "../../../../types/api"
import ComponentArray from "../../../components/ComponentArray"
import { databasePropTypes } from "../helpers/listsItems"
import setModalIndex from "../../../helpers/setModalIndex"
import {TModuleSchemesDatabaseForm, TModuleSchemesDatabasePropertyRow, TModuleSchemesDatabasesTab} from "../_types";

const DatabasePropertyRow: React.FC<TModuleSchemesDatabasePropertyRow> = ({ parentArticle, rowIndex }) => {
...
const DatabaseForm: React.FC<TModuleSchemesDatabaseForm> = props => {
...
const DatabasesTab: React.FC<TModuleSchemesDatabasesTab> = ({ schemes, mutate, deleteScheme }) => {
    const [selectedScheme, setSelectedScheme] = useState<string | undefined>(undefined)
    const { data } = useSchemes<TApiDatabaseScheme>("db", "db", selectedScheme)
