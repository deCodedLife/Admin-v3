...
import { TApiPageScheme } from "../../../../types/api"
...
import {TModuleSchemesPageForm, TModuleSchemesPagesTab, TModuleSchemesPageStructureRow} from "../_types";

export type TPageStructureArea = { parentArticle: string, area: any, setFieldValue: (article: string, value: any) => void, handleDeleteArea: () => void }

export type TPageStructureTab = {
...
export type TPageStructureSettings = { parentArticle: string }

const PageStructureArea: React.FC<TPageStructureArea> = ({ parentArticle, area, setFieldValue, handleDeleteArea }) => {
...
const PageStructureTab: React.FC<TPageStructureTab> = props => {

    const { parentArticle, structure, index, isLastTab, setFieldValue, handleDeleteTab, handleSwapTabs } = props
...
const PageStructureSettings: React.FC<TPageStructureSettings> = ({ parentArticle }) => {
...
const PageStructureRow: React.FC<TModuleSchemesPageStructureRow> = ({ parentArticle, structure, handleDelete, setFieldValue }) => {
...
const PageForm: React.FC<TModuleSchemesPageForm> = ({ data, selectedScheme, mutate, deleteScheme = () => { } }) => {
...
const PagesTab: React.FC<TModuleSchemesPagesTab> = ({ schemes, mutate, deleteScheme }) => {
    const [selectedScheme, setSelectedScheme] = useState<string | undefined>(undefined)
    const { data } = useSchemes<TApiPageScheme>("page", "page", selectedScheme)
