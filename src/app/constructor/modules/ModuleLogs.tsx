...
import { ModuleLogsLogType, ModuleLogsType } from "../../types/modules"
...
const LogItem: React.FC<ModuleLogsLogType> = (props) => {
    const intl = useIntl()
...
const ModuleLogs: React.FC<ModuleLogsType> = ({ type, components, settings }) => {
    const intl = useIntl()
    ...
    const { data, isLoading: loading } = useItem<Array<ModuleLogsLogType>>(object, filter)
