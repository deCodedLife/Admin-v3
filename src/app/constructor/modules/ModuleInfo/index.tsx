...
import { TModuleInfoArea, TModuleInfoBlock, TModuleInfoField, TModuleInfo } from "./_types"
import ComponentButton from "../../components/ComponentButton"
import ComponentInfo from "../../components/ComponentInfo"
import ComponentTooltip from "../../components/ComponentTooltip"


const getAreaKey = (area: TModuleInfoArea) => {
...
const InfoField: React.FC<TModuleInfoField> = (props) => {
...
//Блок полей 
const InfoBlock: React.FC<TModuleInfoBlock> = ({ title, fields }) => {
...
const ModuleInfo: React.FC<TModuleInfo> = ({ settings, components }) => {
