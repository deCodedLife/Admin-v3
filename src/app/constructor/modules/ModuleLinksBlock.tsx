...
import { ModuleLinksBlockLinkType, ModuleLinksBlockType } from "../../types/modules"

const LinkBlock: React.FC<ModuleLinksBlockLinkType> = ({title, link, icon}) => {
...
const ModuleLinksBlock: React.FC<ModuleLinksBlockType> = (props) => {
